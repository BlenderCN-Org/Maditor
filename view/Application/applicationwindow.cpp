...
namespace Maditor
{
	namespace View
	{
		ApplicationContainerWindow::ApplicationContainerWindow(Model::ApplicationLauncher* app) :
			...
			mLog(nullptr)
		{
			connect(app, &Model::EmbeddedLauncher::applicationSettingup, this,
			        &ApplicationContainerWindow::onApplicationSettingup);
			connect(app, &Model::EmbeddedLauncher::applicationSetup, this,
			        &ApplicationContainerWindow::onApplicationSetup);
			connect(app, &Model::EmbeddedLauncher::applicationShutdown, this,
			...
			setConnections({
				{actionSetup, &Model::EmbeddedLauncher::setup},
				{actionShutdown, &Model::EmbeddedLauncher::shutdown},
				{actionKill, &Model::EmbeddedLauncher::kill},
