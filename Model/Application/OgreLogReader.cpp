...
namespace Maditor {
	namespace Model {
		...
		void OgreLogReader::receiveImpl(const std::string & msg, int level, const std::string & logName, const std::string & fullTraceback, const std::string & fileName, int lineNr)
		{
